package com.example.applicationreyes
...
//import com.example.practiceofcomposebasic.R
...
fun Activity1()
{
    Column {
        Image(
            painter = painterResource(id = R.drawable.jetpack_bg),
...
fun Activity2()
{
    Column (
        ...
        Image(
            painter = painterResource(id = R.drawable.check_bg),
            contentDescription = null,
            modifier = Modifier
                .width(280.dp)
                .height(280.dp)
    ...
    Box (
        ...
        Card( //q1
            colors = CardDefaults.cardColors(
                containerColor = Color(255, 255, 102),
        ...
        Card( //q3
            colors = CardDefaults.cardColors(
                containerColor = Color(0, 153, 255),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(36, 255, 204),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
